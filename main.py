        ...
        for i, paragraph in enumerate(doc.paragraphs):
            ...
            if context.get("LetterType") == "DAR/Vigilance NOC":
                ...
                if target_phrase in paragraph.text:
                    ...
                    column_widths = [Inches(0.1), Inches(1.5), Inches(1.0), Inches(1.0), Inches(2.9)] # Total 6.5 inches
            ...
            # --- Handle Exam NOC Table Replacement ---
                ...
                column_widths = [Inches(0.1), Inches(1.0), Inches(2.55), Inches(1.0), Inches(1.2), Inches(0.15)] # Total 6.0 inches
