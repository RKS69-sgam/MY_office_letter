...
# --- **लॉगिन क्रेडेंशियल** ---
# यहां अपना मास्टर पासवर्ड सेट करें।
# सुरक्षा के लिए, आप इसे एक पर्यावरण वेरिएबल (environment variable) में रख सकते हैं या bcrypt जैसे हैशिंग का उपयोग कर सकते हैं।
MASTER_PASSWORD = "sgam@4321" # **इसे एक मजबूत और गुप्त पासवर्ड से बदलें**

# --- **लॉगिन फ़ंक्शन** ---
def login_screen():
    """यह फ़ंक्शन लॉगिन स्क्रीन को प्रदर्शित करता है।"""
    st.title("SSE/PW/SGAM")
    password = st.text_input("Passwor", type="password")
    
    if st.button("Login"):
        if password == MASTER_PASSWORD:
            st.session_state['logged_in'] = True
            st.success("Successful!")
            # मुख्य ऐप दिखाने के लिए री-रन करें
            st.experimental_rerun() 
        else:
            st.error("Wrong password. Try again")

# --- **एंट्री पॉइंट: लॉगिन या मुख्य ऐप दिखाएं** ---
# 'logged_in' सेशन स्टेट को इनिशियलाइज़ करें यदि यह मौजूद नहीं है
if 'logged_in' not in st.session_state:
    st.session_state['logged_in'] = False

# यदि लॉग इन नहीं है, तो लॉगिन स्क्रीन दिखाएं; अन्यथा, मुख्य ऐप कार्यक्षमता दिखाएं
if not st.session_state['logged_in']:
    login_screen()
else:
    # --- आपका मुख्य ऐप कोड यहाँ जाएगा ---
    # उदाहरण के लिए, आप अपनी मौजूदा ऐप की सभी कार्यक्षमताओं को इस ब्लॉक के अंदर रख सकते हैं।
    st.title("OFFICE OF THE SSE/PW/SGAM")
    st.write("Welcome in Dashboard")
    # ... आपके बाकी ऐप का कोड यहाँ से शुरू होगा ...
   ...
   def download_word(path):
    ...
    context = {
        ...
        "Reference": "",
        "CopyTo": "",
        "DOR": dor_str if letter_type in ["Engine Pass Letter", "Card Pass Letter"] else ""
    }
    if letter_type == "Duty Letter (For Absent)":
        ...
        officer_option = st.selectbox("अधिकारी/कर्मचारी", [
            "", "सहायक मण्‍डल अभियंता", "मण्‍डल अभिंयता (पूर्व)","मुख्‍य चिकित्‍सा अधीक्षक", "मण्‍डल अभिंयता (पश्चिम)",
    ...
    # Address dropdown logic based on officer
        ...
        jbp_officers = [
            "मण्‍डल अभिंयता (पूर्व)", "मुख्‍य चिकित्‍सा अधीक्षक", "मण्‍डल अभिंयता (पश्चिम)", "मण्‍डल रेल प्रबंधक (कार्मिक)",
